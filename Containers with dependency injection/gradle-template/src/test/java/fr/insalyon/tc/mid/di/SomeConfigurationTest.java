...
public class SomeConfigurationTest {
  private static final List<String> names = Arrays.asList(
      "John", "Didier", "Ashley", "Mary");

      @Test
    public void basic_greeter_class_config() {
      ApplicationContext context = new AnnotationConfigApplicationContext(SomeConfiguration.class);
