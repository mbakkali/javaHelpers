...
public class AnotherGreetingTest {
  private static final List<String> names = Arrays.asList(
      "John", "Didier", "Ashley", "Mary");

  @Test
  public void basic_casual_greeter_xml_config() {
    ApplicationContext context = new ClassPathXmlApplicationContext("/casual-greeter-app.xml");
